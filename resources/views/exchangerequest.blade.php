...
<html lang="ko">
    ...
    <body>
        ...
        <div class="container-dashboard" id="container" style="height: 90.25vh;">
            ...
            <div>
                <form method="GET" action="/exchangereq" autocomplete="off">
                    <div class="input">
                        ...
                        ?>
                        <input type="text" name="id" placeholder="current balance" value="{{$formattedBalance}}" disabled/>
                        <span>KRW</span>
                    </div>
                    <div class="input">
                        <label for=""><p style="color:red; font-weight: bolder; margin-right: 6px">*</p>Exchange Amount</label>
                        <input type="text" name="charge" placeholder="Exchange Amount" required maxlength="6" id="chargeInput" oninput="validateChargeAmount()"/>
                        <span>KRW</span>
                    </div>
                    <div><button type="submit" class="login-btn" style="width: 100%;">Exchange Request</button></div>
                </form>
            </div>
        </div>
        </div>
        <div id="chargeCompleteModal" class="modal">
            <div class="modal-content">
                <p>Your <span>exchange</span> has been completed</p>
